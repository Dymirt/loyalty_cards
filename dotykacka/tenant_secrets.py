...
def _configured_keys() -> list[bytes]:
    ...
    # Compatibility fallback for the first migration. Production should configure
    # a dedicated key before rotating DJANGO_SECRET_KEY.
...
def decrypt_credentials(encrypted_value: str) -> dict[str, str]:
    ...
    raise ImproperlyConfigured("Tenant credentials cannot be decrypted with configured keys.")
